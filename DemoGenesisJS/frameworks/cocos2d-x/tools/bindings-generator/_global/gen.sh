...
JSB_DIR="$CXX_GENERATOR_ROOT/../../../runtime-src/Classes/global/js-binding"
...
LD_LIBRARY_PATH=${CXX_GENERATOR_ROOT}/libclang $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${JSB_DIR}/PseudoManager.ini -t spidermonkey -s PseudoManager -o ${JSB_DIR}
