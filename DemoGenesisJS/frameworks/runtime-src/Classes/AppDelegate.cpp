...
// -----------------custom JSB classes (below)------------------------------
#include "global/js-binding/jsb_pseudo_manager_auto.hpp"
#include "data/js-binding/jsb_data_manager_auto.hpp"
// -----------------custom JSB classes (above)------------------------------
...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("DemoGenesisJS");
#else
        glview = cocos2d::GLViewImpl::createWithRect("DemoGenesisJS", Rect(0, 0, 750, 1334));
#endif
    ...
    // -----------------custom JSB classes (below)------------------------------
    sc->addRegisterCallback(register_all_jsb_pseudo_manager_auto);
    sc->addRegisterCallback(register_all_jsb_data_manager_auto);
    // -----------------custom JSB classes (above)------------------------------
